...
local Users = redis:smembers(bot_id.."StarK:UsersBot")
local Groups = redis:smembers(bot_id..'StarK:Chek:Groups') 
for i = 1, #Groups do
redis:sadd(bot_id..'ChekBotAdd',Groups[i])  
local list1 = redis:smembers(bot_id..'StarK:Basic:Constructor'..Groups[i])
for k,v in pairs(list1) do
redis:sadd(bot_id.."President:User"..Groups[i], v)
end
local list2 = redis:smembers(bot_id..'StarK:Constructor'..Groups[i])
for k,v in pairs(list2) do
redis:sadd(bot_id.."Constructor:Group"..Groups[i], v)
end
local list3 = redis:smembers(bot_id..'StarK:Manager'..Groups[i])
for k,v in pairs(list3) do
redis:sadd(bot_id.."Manager:Group"..Groups[i], v)
end
local list4 = redis:smembers(bot_id..'StarK:Mod:User'..Groups[i])
...
download_to_file('https://raw.githubusercontent.com/STARK-VPS/StarKl/main/StarK.lua','StarK.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/StarKTeam/Files_StarK/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
if Get_info then
local TextS = "\n⌔︙قائمه ملفات متجر سورس StarK\n⌔︙الملفات المتوفره حاليا\n━━━━━━━━━━━━━\n\n"
...
local Get_Json, Res = https.request("https://raw.githubusercontent.com/StarKTeam/Files_StarK/master/Files_StarK/"..File_Name)
if Res == 200 then
...
local File_Name = File_Get[2]..'.lua'
local Get_Json, Res = https.request("https://raw.githubusercontent.com/STARK-VPS/StarKl/main/StarK/"..File_Name)
if Res == 200 then
...
𓂅 . [StarK iNDT](t.me/XRXNR)     
 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
𓂅 . [TWS StarK](t.me/BBLBB0)     
]]) 
